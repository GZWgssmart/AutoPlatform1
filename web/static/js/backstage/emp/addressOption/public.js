...
function sendCitiesAjax() {
	$.ajax({
		type: "get",
		url: '/static/js/backstage/emp/addressOption/queryAllCities.js',
		async: false,
		dataType: "json",
...
function sendAllProvinceAjax() {
	$.ajax({
		type: "get",
		url: '/static/js/backstage/emp/addressOption/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() {
	$.ajax({
		type: "get",
		url: '/static/js/backstage/emp/addressOption/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 {
	$.ajax({
		type: "get",
		url: "/static/js/backstage/emp/addressOption/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
