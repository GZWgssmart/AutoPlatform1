        ...
        <div class="modal-content" style="overflow:hidden;">
            <form class="form-horizontal" onsubmit="return checkAdd()" id="addForm" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" placeholder="请输入购买数量" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">购买单价：</label>
                    <div class="col-sm-7">
                        <input type="text" placeholder="请输入购买单价" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">购买总价：</label>
                    <div class="col-sm-7">
                        <input type="text" placeholder="请输入购买总价" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">购买折扣：</label>
                    <div class="col-sm-7">
                        <input type="text" placeholder="请输入购买折扣" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">购买最终价：</label>
                    <div class="col-sm-7">
                        <input type="text" placeholder="请输入购买最终价" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" placeholder="购买记录状态" class="form-control">
                    </div>
                </div>
                <div class="form-group">
